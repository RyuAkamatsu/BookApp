...
export default function LibraryIndexTab() {
    ...
    const renderHeader = () => (
        <View style={[commonStyles.header, { paddingTop: insets.top + getCommonStyles(theme).spacing.xl }]}>
            <View style={commonStyles.spaceBetween}>
                <View style={{ flex: 1 }}>
                    <Text style={commonStyles.headerTitle}>My Library</Text>
    ...
    const renderQuickActions = () => (
        <View style={styles.quickActions}>
            <TouchableOpacity 
                ...
                onPress={() => router.push('/(tabs)/library/scan')}
            >
                <Camera size={20} color={theme.colors.surface} />
                <Text style={[commonStyles.primaryButtonText, { marginLeft: getCommonStyles(theme).spacing.sm }]}>
                    Scan Books
                </Text>
            </TouchableOpacity>
            
            <TouchableOpacity 
                style={[commonStyles.secondaryButton, styles.quickActionButton]}
                onPress={() => router.push('/(tabs)/library/manual-add')}
            >
                <Plus size={20} color={theme.colors.primary} />
                <Text style={[commonStyles.secondaryButtonText, { marginLeft: getCommonStyles(theme).spacing.sm }]}>
                    Add Manually
                </Text>
            </TouchableOpacity>
        </View>
    ...
    const renderEmptyState = () => (
        <View style={[commonStyles.center, styles.emptyState]}>
            ...
            <Text style={[commonStyles.title, styles.emptyTitle]}>Start Your Library</Text>
            <Text style={[commonStyles.body, styles.emptySubtitle]}>
                Scan your bookshelf or add books manually to begin building your digital library
            </Text>
        </View>
    );
...
const styles = StyleSheet.create({
    ...
    quickActions: {
        ...
        gap: getCommonStyles(useTheme()).spacing.md,
    },
    quickActionButton: {
        flex: 1,
        flexDirection: 'row',
